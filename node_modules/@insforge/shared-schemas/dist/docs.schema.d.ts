import { z } from 'zod';
export declare const sdkFeatureSchema: z.ZodEnum<["db", "storage", "functions", "auth", "ai", "realtime", "payments"]>;
...
export declare const docTypeSchema: z.ZodEnum<["instructions", "auth-sdk", "db-sdk", "storage-sdk", "functions-sdk", "ai-integration-sdk", "real-time", "deployment", "payments"]>;
